...
if __name__ == "__main__":
    ...
    input_img = "/home/nabu/workspace/pytorch_env/deepNN_py/carpet_script/bw_convert_train/path_calcualtion/difference_img_patched/color/000.png"
    if input_img is None:
        print("Could not open or find the image:",input_img)
        exit(0)
