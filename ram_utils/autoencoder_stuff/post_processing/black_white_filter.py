...
def main(image,filename,good_img,output):
    ...
    cv2.imshow(f'{filename}contours_all', img_contour_all)
...
if __name__ == "__main__":
    ...
    # datatype = ["good"]
    output = "/home/nabu/workspace/pytorch_env/deepNN_py/carpet_script/bw_convert_train/path_calcualtion/contours_inference_img"
